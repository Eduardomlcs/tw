    ...
    villages.forEach((village, index) => {
        ...
        barbsTable += `
			<tr>
				...
				<td>
					${wall !== '?' ? wall : '<b style="color:red;">?</b> <input type="text" id="wallvl"></input>'}
				</td>
				<td>
					${reportTime}
				</td>
				<td>
					<a href="${game_data.link_base_pure}place&target=${villageId}${unitsToSend}&wall=${wall !== '?' ? wall : document.getElementById("wallvl").value}" onClick="highlightOpenedCommands(this);" class="ra-clear-barb-wall-btn btn" target="_blank" rel="noopener noreferrer">
						${tt('Attack')}
					</a>
				</td>
			</tr>
